...
# Geoname table
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy geoname from allCountries.txt null as '';"
...
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy alternatename from alternateNames.txt null as '';"
...
# isolanguagecodes
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy isolanguage from iso-languagecodes.txt null '' delimiter E'\t' csv header;"
...
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy countryinfo from countryInfo2.txt null as '';"
...
# timezones
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy timezones from timeZones.txt null '' delimiter E'\t' csv header;"
...
# admin1codesascii
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy admin1codesascii from admin1CodesASCII.txt null as '';"
...
# admin2codes
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy admin2codes from admin2Codes.txt null as '';"
...
# featurecodes
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy featurecodes from featureCodes_en.txt null as '';"
...
# usertags
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy usertags from userTags.txt null as '';"
...
# hierarchy
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy hierarchy from hierarchy.txt null as '';"

# admincode5
$PSQL --host=$DBHOST --port=$DBPORT  --username=$DBUSER --dbname=$GEONAMESDB -c "\copy admincode5 from adminCode5.txt null as '';"
